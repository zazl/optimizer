...
<html>
    <head>
		...
		<%
			...
			JSAnalysisData analysisData = jsOptimizer.getAnalysisData(new String[] {"test.Circular"});
		...
		<%
				...
				String url = request.getContextPath() +"/_javascript?modules=test.Circular&version="+checksum+"&locale="+request.getLocale();
		%>
				<script type="text/javascript" src="<%=url%>"/></script>
		<%
		    }
