...
public class RhinoAMDCircularDependencyTest extends AMDCircularDependencyTest {
	public RhinoAMDCircularDependencyTest(BundleContext bundleContext, String[] ids) {
