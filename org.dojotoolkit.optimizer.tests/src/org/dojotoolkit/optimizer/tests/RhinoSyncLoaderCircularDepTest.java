...
public class RhinoSyncLoaderCircularDepTest extends SyncLoaderCircularDepTest {
	public RhinoSyncLoaderCircularDepTest(BundleContext bundleContext, String[] ids) {
